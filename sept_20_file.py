...
def mask_allowed(N_index, l_index, j_index):
    ...
    if N_index == 1:
        if l_index == 0 and j_index == 0:
            physical_val = True
        elif l_index == 0  and j_index == 1:
            physical_val = False
        else:
            physical_val = False
                                        ...
                                        for f1 in range(len(F1)):
                                            for f2 in range(len(F2)):
                                                for f3 in range(len(F3)):
                                                    ...
                                                    if mask_allowed(N0, l0, j0) == True and mask_allowed(N1, l1, j1) == True:
                                                        mask_array[N0, l0, j0, k0, f0, f1, N1, l1, j1, k1, f2, f3] = True
                                                    else:
                                                        masked_array[N0, l0, j0, k0, f0, f1, N1, l1, j1, k1, f2, f3] = False
...
Lambda0_1s_1s_inv = np.linalg.pinv(Lambda0_1s_1s_masked)
Lambda0_1s_exc_inv = np.linalg.pinv(Lambda0_1s_exc_masked)
Lambda0_exc_1s_inv = np.linalg.pinv(Lambda0_exc_1s_masked)
Lambda0_exc_exc_inv = np.linalg.pinv(Lambda0_exc_exc_masked)

L0_1s_1s_inv = np.linalg.pinv(L0_1s_1s_masked)
L0_1s_exc_inv = np.linalg.pinv(L0_1s_exc_masked)
L0_exc_1s_inv = np.linalg.pinv(L0_exc_1s_masked)
L0_exc_exc_inv = np.linalg.pinv(L0_exc_exc_masked)

L2_1s_1s_inv = np.linalg.pinv(L2_1s_1s_masked)
L2_1s_exc_inv = np.linalg.pinv(L2_1s_exc_masked)
L2_exc_1s_inv = np.linalg.pinv(L2_exc_1s_masked)
L2_exc_exc_inv = np.linalg.pinv(L2_exc_exc_masked)
