...
# Values considered when summing over quantum numbers to determine Lmabda


numN = 10 # Largest N value considered. Will go from 1 to numN.
numL = numN # Number of allowed L values.
										...
										for f1 in range(len(F1)):
											for f2 in range(len(F2)):
												for f3 in range(len(F3)):
													...
													Lambda0[N0, L0, j0, K0, f0, f1, N1, L1, j1, K1, f2, f3] += Nhat_term + RA_unpert + RS_unpert + RE_total
